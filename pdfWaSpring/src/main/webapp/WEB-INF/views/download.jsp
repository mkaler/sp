			...
			<div class= "container">
				<div class="panel panel-success">
				      ...
				      <div class="panel-body">
							...
							<p>Download the files in zip format
								<button form = "download" type="submit" class="btn btn-default" onclick="submit">
				...
				<div class="panel panel-info">
				      ...
				      <div class="panel-body">
							...
							<p>View your files before downloading
								<button form = "preview" type="submit" class="btn btn-default" onclick="submit">
